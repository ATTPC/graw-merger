...
namespace getevt
{
     ...
     */
        ...
        public:
            ...
            Bad_File(const char *filename_in)
            { msg.append(filename_in); };

            //! \overload
            Bad_File(const std::string& filename_in)
            { msg.append(filename_in); };
        ...
        public:
            //! \param filename_in The name of the file.
            File_Open_Failed(const char *filename_in)
            { msg.append(filename_in); };

            //! \overload
            File_Open_Failed(const std::string filename_in)
            { msg.append(filename_in); };
     ...
     */
        ...
        public:
            //! \param filename_in The name of the file.
            Wrong_File_Type(const char *filename_in)
            { msg.append(filename_in); };

            //! \overload
            Wrong_File_Type(const std::string filename_in)
            { msg.append(filename_in); };
        ...
        public:
            ...
            Does_Not_Exist(const char *filename_in)
            { msg.append(filename_in); };

            //! \overload
            Does_Not_Exist(const std::string& filename_in)
            { msg.append(filename_in); };
        ...
        public:
            ...
            Dir_is_Empty(const char *filename_in)
            { msg.append(filename_in); };

            //! \overload
            Dir_is_Empty(const std::string& filename_in)
            { msg.append(filename_in); };
     ...
     */
        ...
        public:
            //! \param filename_in The name of the directory.
            File_Already_Read(const char *filename_in)
            { msg.append(filename_in); };

            //! \overload
            File_Already_Read(const std::string& filename_in)
            { msg.append(filename_in); };
     ...
     */
        ...
        public:
            //! \param filename_in The filename or path.
            Frame_Out_of_Order(const char *filename_in)
            { msg.append(filename_in); };

            //! \overload
            Frame_Out_of_Order(const std::string& filename_in)
            { msg.append(filename_in); };
        ...
        public:
            Pad_Not_Mapped(int pad)
            { msg.append(std::to_string(pad)); };
